...
- **`./CAPSTONE_II_WRF_MODEL_Research_Paper`**: Directory containing the IEEE formatted Research Paper in the IEEEtran Latex template. *`CAPSTONE_II_WRF_MODEL_Research_Paper.pdf`* contains comprehensive recap of the project's outcomes and insights.
